...
export default function Section6() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#0D1F3C] py-16 sm:py-20 lg:py-24">
      <div className="absolute top-1/2 left-1/2 h-[320px] w-[320px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#F5A623]/5 blur-[90px] animate-pulse-slow motion-reduce:animate-none sm:h-[520px] sm:w-[520px] lg:h-[600px] lg:w-[600px] lg:blur-[120px]" />
      <div className="absolute top-0 right-0 h-[220px] w-[220px] rounded-full bg-[#1B4F8A]/20 blur-[70px] animate-pulse-slow motion-reduce:animate-none sm:h-[300px] sm:w-[300px] sm:blur-[80px]" style={{ animationDelay: "3s" }} />
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6">
        <div className={`transition-all duration-500 ease-out motion-reduce:transition-none ${visible ? "opacity-100 scale-100" : "opacity-0 scale-75"}`}>
          <svg className="mx-auto h-12 w-12 text-[#F5A623]/30 sm:h-16 sm:w-16" fill="currentColor" viewBox="0 0 24 24">
        ...
        <blockquote className={`mt-5 sm:mt-8 premium-font-galdgdersemi text-xl sm:text-3xl lg:text-4xl leading-relaxed text-white transition-all duration-700 delay-150 motion-reduce:transition-none ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          We make quality printing accessible and affordable for every business and individual.
        </blockquote>
        ...
        <div className={`mt-8 transition-all duration-500 delay-300 motion-reduce:transition-none ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          ...
          <p className="mt-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#F5A623]">Our Mission</p>
        </div>
          ...
          {[
            {
              ...
              title: "Quality",
              desc: "Premium materials and professional equipment on every order",
            },
            {
              icon: (
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              title: "Creative",
              desc: "Custom designs and creative solutions for unique requirements",
            },
            {
              icon: (
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              title: "Affordable",
              desc: "Competitive pricing for retail and wholesale customers",
            },
          ].map((v) => (
            <div
              key={v.title}
              className="group rounded-xl border border-white/15 bg-white/[0.08] p-5 shadow-[0_18px_45px_rgba(0,0,0,0.18)] backdrop-blur-2xl transition-all duration-300 ease-out motion-reduce:transition-none hover:border-[#F5A623]/35 hover:bg-white/[0.14] hover:shadow-[0_22px_55px_rgba(0,0,0,0.24)] sm:p-6 sm:hover:scale-[1.03] cursor-default"
            >
              <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full border border-white/15 bg-white/10 text-[#F5A623] shadow-inner backdrop-blur-xl transition-all duration-300 group-hover:bg-[#F5A623] group-hover:text-white group-hover:shadow-lg">
                {v.icon}
              </div>
